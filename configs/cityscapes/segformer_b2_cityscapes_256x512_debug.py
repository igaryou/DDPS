"""Eight-image Stage-1 integration config (2 iterations per epoch)."""

_base_ = ['./segformer_b2_cityscapes_256x512_800ep_pretrain.py']
...
evaluation = dict(interval=2 * iters_per_epoch)
lr_config = dict(
...
work_dir = (
    ...
    'segformer_b2_pretrain_256x512_debug')
